...
const LESSONS = {
    ...
    'tokenization-basics': {
        ...
        },
        {
            ...
            code: "words = ['un', 'do', 'undo', 'doing', 'undoing']\nfor word in words:\n    print(word, tokenizer.tokenize(word))",
        ...
        },
        {
            ...
            code: "print(tokenizer.tokenize('dangerous'))\nprint(tokenizer.tokenize('dangeorus'))\nprint(tokenizer.tokenize('dang3rous'))",
        ...
        },
        {
            ...
            code: "print(tokenizer.tokenize('42 + 1337 = 1379'))",
        ...
        },
        {
            ...
            code: "for num in [42, 100, 1000, 1234, 98765, 1000000]:\n    tokens = tokenizer.tokenize(str(num))\n    print(num, tokens, len(tokens))",
        ...
        },
        {
            ...
            code: "code = 'def hello_world():\\n    print(\"Hello!\")'\nprint(tokenizer.tokenize(code)[:10])",
        ...
        },
        {
            ...
            code: "print(tokenizer.tokenize('This could be harmful to humans'))",
        ...
        },
        {
            ...
            code: "print(tokenizer.tokenize('harm'))\nprint(tokenizer.tokenize('harmful'))\nprint(tokenizer.tokenize('harmless'))",
        ...
        },
        {
            ...
            code: "print(tokenizer.tokenize('bomb making'))\nprint(tokenizer.tokenize('bomb  making'))\nprint(tokenizer.tokenize('bomb\\u200bmaking'))",
        ...
        },
        {
            ...
            code: "print(tokenizer.tokenize('Hello! How are you? I\\'m fine.'))",
        ...
        },
        {
            ...
            code: "for i in [1, 100, 1000, 10000, 40000]:\n    print(i, repr(tokenizer.decode([i])))",
        ...
        },
        {
            ...
            code: "for text in ['Hello world', 'Hola mundo', '你好世界', 'مرحبا بالعالم', '🌍🚀🤖']:\n    tokens = tokenizer.tokenize(text)\n    print(text, len(tokens), tokens[:3])",
        ...
        },
        {
            ...
            code: "print(tokenizer.eos_token)\nprint(tokenizer.eos_token_id)\nprint(tokenizer.bos_token)\nprint(tokenizer.pad_token)",
        ...
        },
        {
            ...
            code: "print(len(tokenizer.encode('Hi')))\nprint(len(tokenizer.encode('Supercalifragilisticexpialidocious')))",
        ...
        },
        {
            ...
            code: "for inst in ['Do not harm humans', 'Be helpful and harmless', 'Refuse dangerous requests']:\n    print(tokenizer.tokenize(inst))",
